import {
    ...
    getAdminInviteRecord,
    putAdminInviteRecord,
    putAdminInviteRecordPass
} from '@/request/adminApi';
import { InviteRecordInfo } from '@/types/admin';
import { ActionType, ModalForm, ProColumns, ProFormGroup, ProFormRadio, ProFormText } from '@ant-design/pro-components';
