import { getAdminPayment, delAdminPayment, addAdminPayment, putAdminPayment } from '@/request/adminApi';
...
function PaymentPage() {
    ...
    const columns: ProColumns<PaymentInfo>[] = [
        ...
        },
        {
            title: '状态值',
            dataIndex: 'status',
            render: (_, data) => <Tag color={data.status ? 'green' : 'red'}>{data.status ? '上线' : '下线'}</Tag>
        },
        {
            title: '创建时间',
    ...
    return (
        <div>
            ...
            >
                <ProFormText name="name" label="渠道名称" rules={[{ required: true, message: '请输入渠道名称' }]} />
                <ProFormGroup>
