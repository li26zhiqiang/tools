...
function RoleLocal() {
    ...
    const [promptInfoModal, setPromptInfoModal] = useState<PromptInfo & { open: boolean; oldKey: string }>({
        oldKey: '',
        open: false,
        key: '',
        value: ''
    ...
    return (
        <div className={styles.roleLocal}>
            ...
            >
                <ProFormText width="lg" name="key" label="标题" rules={[{ required: true, message: '请输入标题!' }]} />
                <ProFormTextArea
                    width="lg"
                    name="value"
                    label="内容"
