...
export interface ChatState {
    ...
    // 给对话添加数据
    setChatInfo: (id: string | number, data?: ChatGpt, info?: ChatsInfo | { [key: string]: any }) => void;
    // 修改对话数据
    setChatDataInfo: (id: string | number, messageId: string | number, info?: ChatGpt | { [key: string]: any }) => void;
    // 清理当前会话
